...
export default function Home() {
  ...
  const handleAddColaborador = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!novoNome.trim() || !novoSetor.trim()) return;
  ...
  return (
    <div className="flex flex-col items-center min-h-screen p-8 gap-8 bg-white text-black">
      <h2 className="text-2xl font-bold mb-2">Controle de EPI - Creme de proteção</h2>
      <h3 className="text-base font-medium mb-4 text-gray-600">validade de 1 mês</h3>
